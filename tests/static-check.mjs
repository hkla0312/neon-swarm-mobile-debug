...
for(const token of ['CharacterDefinition','ProceduralCharacterRenderer','MeshToonMaterial','CapsuleGeometry','swordTrail','spawnDeath','animPhase','InstancedMesh'])if(!(code+visual).includes(token))throw new Error(`Visual marker missing: ${token}`);
